...
We need these packages"tidyverse","tibble","ggiraph","sf","ggplot2","ggspatial","dplyr","raster","tmap","clock","highcharter","ggforce" for analysing and visualization. Expected mapping includes histogram, trajectory graph, heat map, node graph and so on.
